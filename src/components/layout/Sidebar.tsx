...
import { 
  ...
  Bell, FileText, Settings, HelpCircle, DollarSign
} from 'lucide-react';
...
export const Sidebar: React.FC = () => {
  ...
  const entrepreneurItems = [
    ...
    // --- NEW: Financial Hub added for Entrepreneurs ---
    { to: '/deals', icon: <DollarSign size={20} />, text: 'Financial Hub' }, 
  ];
  ...
  const investorItems = [
    ...
    { to: '/messages', icon: <MessageCircle size={20} />, text: 'Messages' },
    { to: '/notifications', icon: <Bell size={20} />, text: 'Notifications' },
    // --- UPDATED: Renamed from Deals to Financial Hub for Investors ---
    { to: '/deals', icon: <DollarSign size={20} />, text: 'Financial Hub' },
  ];
